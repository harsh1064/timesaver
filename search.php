...
include("config.php");
 ...
 $result3=mysqli_query($con,"select * from tbl_category where cat_name='$search_query'");
 $count3=mysqli_num_rows($result3);
 $result4=mysqli_query($con,"select * from tbl_service where service_name='$search_query'");
...
{
$id=$row1['cat_id'];
$sql = "select * from tbl_service where status = '0' and cat_id=$id";
}
 }
 else if($count4>0)
 {
...
{
$id=$row1['service_id'];
$link="serviceinfo.php?service_id=";
$link .=$id;
echo $link;
$link1="<script language='javascript'>window.location.href='";
$link1 .=$link;
$link1 .="'</script>";
echo $link1;
}  
 ...
 {
$sql = "select * from tbl_service where status = '0' and service_name like '%$search_query%'";
 }
