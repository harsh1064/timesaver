            	...
            	<div class="clearfix">
                    ...
                    <div class="top-left">
                    	<ul class="links clearfix">
                            ...
                            <li><a href="#" style="font-size:17px"><span class="icon fa fa-envelope"></span><?php echo $email;?></a></li>
                        </ul>
                    </div>
...
?>
                                    ...
                                    <!-- <li><a href="compair.php">Service comparison </a></li> -->
                                    ...
                                    <li class="dropdown"><a href="#">My account</a>
                                        <ul>
                                            ...
                                            <li><a href="bookingstatus.php">service booking status</a></li>
